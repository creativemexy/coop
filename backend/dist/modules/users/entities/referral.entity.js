...
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.Column)({ name: 'referee_id', nullable: true }),
    __metadata("design:type", String)
], Referral.prototype, "refereeId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'referee_email', length: 255 }),
    __metadata("design:type", String)
], Referral.prototype, "refereeEmail", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.Column)({ name: 'referral_code', length: 20 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ type: 'decimal', name: 'reward_amount', precision: 15, scale: 2, default: 0 }),
    __metadata("design:type", Number)
], Referral.prototype, "rewardAmount", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'reward_paid', default: false }),
