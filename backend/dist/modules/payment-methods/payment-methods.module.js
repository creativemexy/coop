...
const saved_payment_method_entity_1 = require("./entities/saved-payment-method.entity");
...
exports.PaymentMethodsModule = PaymentMethodsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([saved_payment_method_entity_1.SavedPaymentMethod])],
