...
], InstallmentsController.prototype, "findBySubscription", null);
__decorate([
    (0, common_1.Get)('all'),
    ...
    __metadata("design:returntype", Promise)
], InstallmentsController.prototype, "listAll", null);
__decorate([
    (0, common_1.Get)('reconciliation/:subscriptionId'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.BNPL_MANAGER, role_enum_1.Role.BUSINESS_MANAGER, role_enum_1.Role.SUPER_ADMIN),
    __param(0, (0, common_1.Param)('subscriptionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], InstallmentsController.prototype, "getReconciliation", null);
__decorate([
    (0, common_1.Post)(':id/pay'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ACCOUNTANT, role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.BNPL_MANAGER),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], InstallmentsController.prototype, "retryInstallment", null);
exports.InstallmentsController = InstallmentsController = __decorate([
    (0, common_1.Controller)('api/v1/bnpl/installments'),
