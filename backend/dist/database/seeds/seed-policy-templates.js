...
exports.seedPolicyTemplates = seedPolicyTemplates;
...
const POLICY_SEEDS = [
    {
        ...
        description: 'Governs the creation, configuration and launch of BNPL products across all tenants. Any new product or material change to tenor, pricing or limits requires a reviewed template before going live.',
        templateType: policy_template_entity_1.PolicyTemplateType.BNPL_PRODUCT,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
            minTenorDays: 14,
            maxTenorDays: 365,
    ...
    },
    {
        ...
        description: 'Defines the controlled deactivation of BNPL products, including customer notification windows, pending-order handling and re-activation criteria.',
        templateType: policy_template_entity_1.PolicyTemplateType.BNPL_PRODUCT,
        status: policy_template_entity_1.PolicyTemplateStatus.DRAFT,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Legacy draft setting hard exposure caps for secondary/supplement lending. Rejected during review due to insufficient risk controls and missing board sign-off.',
        templateType: policy_template_entity_1.PolicyTemplateType.BNPL_PRODUCT,
        status: policy_template_entity_1.PolicyTemplateStatus.REJECTED,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Baseline identity verification for low-value onboarding. Establishes the minimum identity documents and transaction limits for basic accounts.',
        templateType: policy_template_entity_1.PolicyTemplateType.KYC_REQUIREMENT,
        status: policy_template_entity_1.PolicyTemplateStatus.SUPERSEDED,
        version: 1,
        rules: {
            kycLevel: 'basic',
            idTypes: ['BVN'],
    ...
    },
    {
        ...
        description: 'Updated Tier-1 baseline requiring NIN alongside BVN and adding liveness verification, reflecting the enhanced verification framework rolled out this year.',
        templateType: policy_template_entity_1.PolicyTemplateType.KYC_REQUIREMENT,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 2,
        rules: {
    ...
    },
    {
        ...
        description: 'Standard verification tier for mid-value onboarding, requiring government-issued photo ID, liveness check and physical address confirmation.',
        templateType: policy_template_entity_1.PolicyTemplateType.KYC_REQUIREMENT,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Heightened scrutiny for high-value or flagged customers, defining the triggers and documentation required before elevated limits are granted.',
        templateType: policy_template_entity_1.PolicyTemplateType.KYC_REQUIREMENT,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Defines approval thresholds and dual-control requirements for loan disbursements, ensuring larger advances receive commensurate review.',
        templateType: policy_template_entity_1.PolicyTemplateType.MANAGER_ACTION,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Sets the aging thresholds and approval chain for charging off and writing off delinquent loans, including board-level sign-off requirements.',
        templateType: policy_template_entity_1.PolicyTemplateType.MANAGER_ACTION,
        status: policy_template_entity_1.PolicyTemplateStatus.PENDING_APPROVAL,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Bounds the annual interest rates chargeable on BNPL facilities and ties the maximum allowed rate to the customer risk score band.',
        templateType: policy_template_entity_1.PolicyTemplateType.INTEREST_RATE,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
            annualRateMin: 0.05,
    ...
    },
    {
        ...
        description: 'Governs discounted promotional interest rates, limiting their duration, depth and customer eligibility to keep campaigns within budget.',
        templateType: policy_template_entity_1.PolicyTemplateType.INTEREST_RATE,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Defines the premium applied once an account enters default and the maximum allowable penalty rate, including compounding behaviour.',
        templateType: policy_template_entity_1.PolicyTemplateType.INTEREST_RATE,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
    ...
    },
    {
        ...
        description: 'Sets the outreach cadence, channels and escalation timeline for recovering overdue balances in-house before any external action.',
        templateType: policy_template_entity_1.PolicyTemplateType.COLLECTION,
        status: policy_template_entity_1.PolicyTemplateStatus.ACTIVE,
        version: 1,
        rules: {
            earlyReminderDay: 5,
    ...
    },
    {
        ...
        description: 'Authorises and constrains the use of licensed third-party collection agencies for aged debt, including data-sharing and escalation rules.',
        templateType: policy_template_entity_1.PolicyTemplateType.COLLECTION,
        status: policy_template_entity_1.PolicyTemplateStatus.PENDING_APPROVAL,
        version: 1,
        rules: {
...
async function seedPolicyTemplates(dataSource) {
    const policyRepo = dataSource.getRepository(policy_template_entity_1.PolicyTemplate);
    ...
    for (const seed of POLICY_SEEDS) {
        const template = policyRepo.create({
            ...
            applicableTenantIds: [],
            ...(seed.status === policy_template_entity_1.PolicyTemplateStatus.ACTIVE
...
//# sourceMappingURL=seed-policy-templates.js.map