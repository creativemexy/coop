...
exports.seedGlobalRiskRules = seedGlobalRiskRules;
...
async function seedGlobalRiskRules(dataSource) {
    const repo = dataSource.getRepository(global_risk_rule_entity_1.GlobalRiskRule);
...
//# sourceMappingURL=seed-global-risk-rules.js.map