...
const TEMPLATES = [
    {
        key: 'welcome_email',
        type: notification_template_entity_1.TemplateType.EMAIL,
...
The {{platform_name}} Team`,
    ...
    {
        key: 'welcome_sms',
        type: notification_template_entity_1.TemplateType.SMS,
        subject: null,
...
async function seedNotificationTemplates(dataSource) {
    const repo = dataSource.getRepository(notification_template_entity_1.NotificationTemplate);
