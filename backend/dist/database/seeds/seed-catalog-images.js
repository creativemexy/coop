...
exports.seedCatalogImages = seedCatalogImages;
...
function generateSvg(name, colorIdx) {
...
async function seedCatalogImages(dataSource) {
    const catalogRepo = dataSource.getRepository(bnpl_catalog_item_entity_1.BnplCatalogItem);
    const imageRepo = dataSource.getRepository(bnpl_catalog_image_entity_1.BnplCatalogImage);
    const dir = (0, path_1.join)(process.cwd(), 'uploads', 'catalog-images');
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        (0, fs_1.writeFileSync)(filePath, svg, 'utf-8');
...
//# sourceMappingURL=seed-catalog-images.js.map