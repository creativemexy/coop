...
export const KORAPAY_ENDPOINTS: Record<KorapayIdentityType, string> = {
  bvn: '/api/v1/identities/ng/bvn',
  nin: '/api/v1/identities/ng/nin',
};
...
export interface KorapayLookupData {
  ...
  validation?: Record<string, { value: string; match: boolean; confidence_rating?: number }>;
  requested_by?: string;
}
