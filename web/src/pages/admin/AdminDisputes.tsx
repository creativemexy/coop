...
export function AdminDisputes() {
  ...
  const fetch = () => {
    ...
    api.get(`/admin/disputes?${params}`).then(r => setDisputes(r.data))
  }
  ...
  const resolve = async () => {
    ...
    await api.patch(`/admin/disputes/${resolveModal.id}/resolve`, { status: resolveStatus, resolution })
    setResolveModal(null); setResolution(''); fetch()
  }

  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold dark:text-gray-100">Dispute Management</h2>
